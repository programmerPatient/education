    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
                ...
                <a href="javascript:;" onclick="admin_add('添加点播','admin-add.html','800','500')" class="btn btn-primary radius">
                    <i class="Hui-iconfont">&#xe600;</i>
                添加点播
            </a>
        </span>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tbody>
            ...
            <tr class="text-c">
                ...
                <td>
                    <a href="javascript:;" onclick="video_play('{{$value->lesson_name}}','/admin/lesson/play?id={{$value->id}}','800','500')" class="btn btn-primary radius">
                        <i class="Hui-iconfont">&#xe6e6;</i>
                        播放
                    </a>
                </td>
